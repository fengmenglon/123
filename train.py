...
parser.add_argument("--root_datasets",default="C://Users//20154//Desktop//彩色数据集扩充二//所有图片汇总",help='Dataset directory path')
parser.add_argument("--target_data_folder",default="C://Users//20154//Desktop//数据集划分//最终数据集划分3",help='target_data_folder directory path')
parser.add_argument("--Save_Confusion_Matrix_folder",default="C://Users//20154//Desktop//Mobilenetv1训练//混淆矩阵",help='Dataset directory path')
parser.add_argument("--Save_weights_folder",default="C://Users//20154//Desktop//Mobilenetv1训练//权重",help='target_data_folder directory path')
