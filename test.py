...
parser.add_argument("--test_dir",default="C://Users//20154//Desktop//数据集划分//最终数据集划分3//test",type=str,help='type of dataset')
parser.add_argument("--weights_path",default="C://Users//20154//Desktop//Mobilenetv1训练//权重//model-155-of-200-0.35321277379989624-0.9257142857142857.pth",type=str,help='weights_path')
parser.add_argument("--json_path",default="E://teach_all-main//pytorch_classifier//MobileNet//MobileNetV2//class_indices.json",type=str,help='json_path')
    ...
    for class_ in os.listdir(args.test_dir):
        ...
        for filename in tqdm(os.listdir(class_path)):
            ...
            if not os.path.exists(image_path):
                ...
                # 1.model 第一次放入GPU
                create_model = MobileNet_v2(theta=1,num_classes=5).to(device)
                # 2. model权重文件
